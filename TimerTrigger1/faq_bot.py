...
def get_last_jb_submission():
    ...
    def extract_date_from_titile(jb_submission):
        ...
        jb_date = dateparser.parse(date_txt)
        return jb_date
    ...
    def is_next_thursday(jb_date):
        ...
        """
        today = datetime.now()
        nb_days_untill_next_thursday = (THURSDAY - today.weekday()) % 7
...
def answer_stupid_questions():
    ...
    if no_questions:
        logger.info("No questions yet on this week jb")
